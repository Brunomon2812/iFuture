        ...
        <Flex flexDir={'column'} >
            ...
            <Flex flexDir={'column'} minH={'100vh'}>
                ...
                <Flex flexDir={'column'} padding={'1rem'} gap={'0.2rem'}>
                    ...
                    {(activeOrder && cartProducts.length === 0) && <Text fontFamily={'Roboto'} align={"center"} color={'#E8222E'}>Order in progress...</Text>}
                    {(cartProducts.length > 0 || activeOrder) ? cartProducts.map((product) => {
                        ...
                        <Text fontFamily={'Roboto'} align={"center"} >Your cart is empty.</Text>}
                    ...
                    <Text fontFamily={'Roboto'} borderBottom={'1px solid black'} paddingBottom={'0.2rem'}>Payment method</Text>
                    <RadioGroup onChange={setPaymentMethod} value={paymentMethod} defaultValue={'1'} display={'flex'} flexDir={'column'} fontFamily={'Roboto'} marginTop={'0.5rem'} gap={'0.4rem'}>
                        <Radio value={'money'} colorScheme={'red'} size={'md'} >Cash</Radio>
                        <Radio value={'creditcard'} colorScheme={'red'} size={'md'} >Credit card</Radio>
                    </RadioGroup>
                    <Button background={'#E8222E'} borderRadius={'0'} h={'2.625rem'} fontWeight={'400'} fontFamily={'Roboto'} marginTop={'1rem'} onClick={() => placeOrder(paymentMethod, restaurantDetails.id)}>Confirm</Button>
                </Flex>
            </Flex>
